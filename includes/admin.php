...
function ahvpo_admin_menu() {
	add_options_page(
		__( 'ArielHF VideoPIP Overlay', 'arielhf-videopip-overlay' ),
		__( 'VideoPIP Overlay', 'arielhf-videopip-overlay' ),
		'manage_options',
...
function ahvpo_admin_page() {
	...
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'ArielHF VideoPIP Overlay', 'arielhf-videopip-overlay' ); ?></h1>
		<p>
			<?php
			echo wp_kses_post(
				sprintf(
