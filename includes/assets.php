	...
	wp_localize_script(
		...
		array(
			...
			'i18n'    => array(
				...
				'subsOn'              => __( 'Desactivar subtítulos', 'arielhf-videopip-overlay' ),
				'subsOff'             => __( 'Activar subtítulos', 'arielhf-videopip-overlay' ),
				'signsOn'             => __( 'Desactivar lengua de señas', 'arielhf-videopip-overlay' ),
				'signsOff'            => __( 'Activar lengua de señas', 'arielhf-videopip-overlay' ),
